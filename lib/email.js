...
export async function sendWelcomeEmail({ name, email }) {
  ...
  const html = `
    ...
    <body>
      <div class="container">
        <div class="card">
          <div class="header">
            <h1>🎯 Welcome to PM SkillsAssess!</h1>
          ...
          <div class="content">
            ...
            <div class="cta">
              <a href="https://gapanalysis-4frt.vercel.app/assessment.html">Start Your Assessment →</a>
            </div>
  ...
  return sendEmail({
    to: email,
    subject: `Welcome to PM SkillsAssess, ${firstName}! 🎯`,
    html,
